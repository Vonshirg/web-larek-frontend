 ...
 **Основные части архитектуры проекта**:
    ...
    - **Отображения**: Компоненты, отображающие продукты, формы, модальные окна и другие элементы интерфейса (`Card`, `StoreItemPreview`, `Page`, `Form`, `Order`, `Contacts`, `Success`, `Basket`, `Modal`).
    - **Экраны**: Отображение различных состояний приложения, таких как страницы магазина и страницы заказа (`Page`).
    - **Работа с сервером**: Выполнение HTTP-запросов для взаимодействия с сервером (`Api`).

**Назначение и функции частей**:
    - **Данные**: Управление данными о продуктах, корзине и заказах.
    - **Отображения**: Отображение информации о продуктах, формах для ввода данных и других элементов интерфейса.
    - **Экраны**: Отображение различных состояний приложения.
    - **Работа с сервером**: Взаимодействие с сервером для получения данных и отправки заказов.

**Взаимодействие частей**:
    - **Данные и отображения**: Отображения обновляются в соответствии с изменениями данных.
    - **Экраны и данные**: Экраны отображают текущие данные и реагируют на их изменения.
    - **Работа с сервером и данные**: Полученные с сервера данные обновляют состояние приложения.

 **Используемые данные**:
    - Конкретные типы данных и интерфейсов, такие как `IProduct`, `ICard`, `IOrder`, `FormErrors`.
...
**Компоненты приложения**:
 ...
 включают в себя:
    ...
    - **Contacts**: Управление формой контактных данных.
