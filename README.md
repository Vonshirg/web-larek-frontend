 ...
 **Основные части архитектуры проекта**:
    ...
    - **Отображения**: Компоненты, отображающие продукты, формы, модальные окна и другие элементы интерфейса (`Card`, `StoreItemPreview`, `Page`, `Form`, `Order`, `Contacts`, `Basket`).
...
Класс `Page` управляет элементами страницы.
