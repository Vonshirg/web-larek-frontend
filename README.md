...
**Взаимодействие частей**:
    ...
    Отправка заказа:
      ...
      Метод deselectAllProducts(): (AppState)  снимает выделение со всех товаров в корзине после успешного размещения заказа. Вероятно, это сделано для очистки выбранных товаров перед следующим заказом.
...
#### Методы
    ...
    deselectAllProducts(): void
        Снимает выделение со всех продуктов в магазине.
...
#### Методы
    ...
    refreshIndices(cards: HTMLElement[])
        Обновляет индексы товаров в корзине.
        Присваивает каждому элементу корзины новый индекс на основе его позиции в списке.
        Функция formatPrice
